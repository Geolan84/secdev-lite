...
- **ФИО:** Ланин Георгий Михайлович
- **Группа:** МСПИН241
- **Контакт:** `gmlanin@edu.hse.ru` / `@LaninGM`
- **Опционально: свой проект (BYO):** Для первой работы было выбрано приложение для заметок. Для следующих заданий здесь будет описан другой проект.
...
Фокус - на проверяемых артефактах в `GRADING/*` и чистой структуре `EVIDENCE/`.
